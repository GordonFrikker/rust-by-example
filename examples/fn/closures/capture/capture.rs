fn main() {
    ...
    // так и `count`, но использование `&mut count` менее ограниченно, так что
    // замыкание выбирает это. Немедленно заимствует `count`.
    //
    ...
    // значение без изменения. Не копируемый тип должен быть перемещён, так что
