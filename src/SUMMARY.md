...
- [Привет, мир!](hello.md)
    ...
    - [Форматированный вывод](hello/print.md)
        ...
        - [Display](hello/print/print_display.md)
            - [Тест: Список](hello/print/print_display/testcase_list.md)
...
- [Типы](types.md)
    - [Преобразование типов](types/cast.md)
...
- [Управление потоком](flow_control.md)
    ...
    - [match](flow_control/match.md)
        ...
        - [Ограничитель шаблонов](flow_control/match/guard.md)
...
- [Функции](fn.md)
    ...
    - [Замыкания](fn/closures.md)
        ...
        - [Примеры из `std`](fn/closures/closure_examples.md)
